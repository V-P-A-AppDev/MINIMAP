    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registrationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                entranceAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(WorkerLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String email = emailInput.getText().toString();
                final String password = passwordInput.getText().toString();
                entranceAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(WorkerLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()){
